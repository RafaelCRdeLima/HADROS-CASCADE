...
def test_pipeline_passes_all_parameters(tmp: Path) -> None:
    config = {
        ...
        "enable_photon_path_compression": False,
        "photon_path_compression_mode": "none",
        "photon_path_compression_stride": 16,
        "photon_path_compression_require_complete_paths": True,
        "photon_path_compression_output_format": "jsonl",
        "photon_medium_model": "none",
        "photon_medium_input_path_mode": "raw_samples",
        "photon_medium_truncated_path_policy": "fail",
        "photon_medium_torus_rho0_g_cm3": 1.0,
        "photon_medium_torus_r0_rg": 50.0,
        "photon_medium_torus_sigma_r_rg": 10.0,
        "photon_medium_torus_H_over_r": 0.2,
...
def test_pipeline_has_no_photon_physical_defaults() -> None:
    ...
    forbidden = [
        ...
        'config.get("photon_density_gray_kappa_per_rg_per_gcm3"',
        'config.get("photon_density_gray_energy_exponent"',
        'config.get("photon_density_gray_reference_energy_gev"',
        'config.get("photon_opacity_truncated_path_policy"',
        ...
        'config.get("enable_photon_path_compression"',
        'config.get("photon_path_compression_mode"',
        'config.get("photon_path_compression_stride"',
        'config.get("photon_path_compression_require_complete_paths"',
        'config.get("photon_path_compression_output_format"',
        ...
        'photon.get("photon_density_gray_kappa_per_rg_per_gcm3"',
        'photon.get("photon_density_gray_energy_exponent"',
        'photon.get("photon_density_gray_reference_energy_gev"',
        'photon.get("photon_opacity_truncated_path_policy"',
        ...
        'photon.get("enable_photon_path_compression"',
        'photon.get("photon_path_compression_mode"',
        'photon.get("photon_path_compression_stride"',
        'photon.get("photon_path_compression_require_complete_paths"',
        'photon.get("photon_path_compression_output_format"',
