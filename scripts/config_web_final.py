        ...
        },
        {
            ...
            "fields": [
                ...
                field(
                    ...
                    "none",
                    kind="select",
                    options=["none", "analytic_torus"],
                    visibility="EXPERT",
                    description="Optional photon medium lookup backend. Phase Medium-A supports only none and analytic_torus; it does not apply opacity.",
                ),
                field(
                    "photon_escape_classifier",
                ...
                field(
                    ...
                    "disabled",
                    kind="select",
                    options=["disabled", "vacuum", "constant_alpha_path", "density_gray_toy"],
                    visibility="EXPERT",
                    description="disabled keeps ideal products. vacuum writes tau=0. constant_alpha_path uses path length. density_gray_toy uses analytic_torus medium-compressed complete paths and is not physical opacity.",
                ),
                field(
                    "photon_escape_classifier",
