        ...
        },
        {
            ...
            "fields": [
                ...
                field(
                    ...
                    kind="checkbox",
                    visibility="EXPERT",
                    description="Runs the optional Phase 6 photon propagation-opacity infrastructure after validation. Initial implementation supports disabled and vacuum only; no real absorption physics is applied.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_opacity_mode",
                    ...
                    "disabled",
                    kind="select",
                    options=["disabled", "vacuum"],
                    visibility="EXPERT",
                    description="disabled keeps current ideal vacuum products. vacuum writes an attenuated file with tau=0, survival=1, and attenuated energy equal to observed energy.",
                ),
                field(
                    "photon_escape_classifier",
