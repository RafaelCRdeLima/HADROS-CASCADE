        ...
        },
        {
            ...
            "fields": [
                ...
                field(
                    ...
                    "disabled",
                    kind="select",
                    options=["disabled", "vacuum", "constant_alpha_path"],
                    visibility="EXPERT",
                    description="disabled keeps ideal products. vacuum writes tau=0. constant_alpha_path writes tau=alpha_const_per_rg * path_length_rg without medium lookup.",
                ),
                field(
                    "photon_escape_classifier",
