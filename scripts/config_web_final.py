        ...
        },
        {
            ...
            "fields": [
                ...
                field(
                    ...
                    kind="checkbox",
                    visibility="EXPERT",
                    description="Writes optional geometric Kerr geodesic path samples for future opacity work. No medium lookup, opacity, absorption, detector, or radiative-transfer quantity is computed.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    kind="number",
                    visibility="EXPERT",
                    description="Writes one path sample every N RK geodesic steps, plus the final observer crossing when available.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_path_sample_max_rows_per_photon",
                    "Photon path max rows per photon",
                    10000,
                    kind="number",
                    visibility="EXPERT",
                    description="Maximum number of geometric path sample rows per photon. Truncated paths are recorded in the path sampling summary.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    options=["jsonl"],
                    visibility="EXPERT",
                    description="Output format for photon_observer_geodesic_path_samples. Only JSONL is supported in Phase 6E-A.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_path_sampling_require_validation",
                    "Require validation for photon path samples",
                    True,
                    kind="checkbox",
                    visibility="EXPERT",
                    description="When enabled, path samples are written only for photons whose Phase 1 invariant diagnostics pass.",
                ),
                field(
                    "photon_escape_classifier",
                    "enable_photon_path_compression",
                    "Enable photon path compression",
                    False,
                    kind="checkbox",
                    visibility="EXPERT",
                    description="Enables Phase 6E-C1 compressed photon path segments after raw path sampling.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    "none",
                    kind="select",
                    options=["none", "fixed_stride_segments"],
                    visibility="EXPERT",
                    description="Compression algorithm for photon geodesic path samples. Phase 6E-C1 supports only fixed_stride_segments.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    kind="number",
                    visibility="EXPERT",
                    description="Number of raw path samples aggregated into each fixed-stride compressed segment.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_path_compression_require_complete_paths",
                    "Require complete paths for compression use",
                    True,
                    kind="checkbox",
                    visibility="EXPERT",
                    description="Marks raw-truncated paths as incomplete for future physical-opacity use.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    options=["jsonl"],
                    visibility="EXPERT",
                    description="Output format for photon_observer_compressed_path_segments. Only JSONL is supported in Phase 6E-C1.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_medium_model",
                    ...
                    "none",
                    kind="select",
                    options=["none", "analytic_torus", "uribe_radial_scalar"],
                    visibility="EXPERT",
                    description="Optional photon medium lookup backend. uribe_radial_scalar provides radial scalar fields only and does not apply opacity.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    "raw_samples",
                    kind="select",
                    options=["raw_samples", "compressed_complete_paths"],
                    visibility="EXPERT",
                    description="Path representation used by photon medium lookup. compressed_complete_paths queries only compressed path segments according to the truncation policy.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    "fail",
                    kind="select",
                    options=["fail", "exclude", "diagnostic_only"],
                    visibility="EXPERT",
                    description="Policy for incomplete compressed paths in medium lookup. fail is conservative; exclude uses only complete paths; diagnostic_only marks the product as non-physical.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    kind="number",
                    visibility="EXPERT",
                    description="Peak density for the synthetic analytic_torus photon medium lookup.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    kind="number",
                    visibility="EXPERT",
                    description="Radial center of the synthetic analytic_torus density profile.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    kind="number",
                    visibility="EXPERT",
                    description="Radial Gaussian width of the synthetic analytic_torus density profile.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_medium_torus_H_over_r",
                    "Photon medium torus H/r",
                    0.2,
                    kind="number",
                    visibility="EXPERT",
                    description="Angular Gaussian width around the equatorial plane for the synthetic analytic_torus medium.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    kind="number",
                    visibility="EXPERT",
                    description="Constant synthetic analytic_torus temperature.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    kind="number",
                    visibility="EXPERT",
                    description="Constant synthetic analytic_torus electron fraction.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    options=["zamo"],
                    visibility="EXPERT",
                    description="Fluid-frame prescription for analytic_torus. Phase Medium-A supports only ZAMO and applies no opacity.",
                ),
                field(
                    "photon_escape_classifier",
                    "uribe_radial_density_path",
                    "Uribe radial density path",
                    "../HADROS/data/uribe/disk-mass-density.dat",
                    kind="text",
                    visibility="EXPERT",
                    description="Path to Juan Uribe radial density table. Used only by photon_medium_model=uribe_radial_scalar.",
                ),
                field(
                    "photon_escape_classifier",
                    "uribe_radial_temperature_path",
                    "Uribe radial temperature path",
                    "../HADROS/data/uribe/disk-temp.dat",
                    kind="text",
                    visibility="EXPERT",
                    description="Path to Juan Uribe radial dimensionless temperature table.",
                ),
                field(
                    "photon_escape_classifier",
                    "uribe_radial_ye_path",
                    "Uribe radial Ye path",
                    "../HADROS/data/uribe/disk-electron-fraction.dat",
                    kind="text",
                    visibility="EXPERT",
                    description="Path to Juan Uribe radial electron-fraction table.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    "uribe_xr_squared_rg",
                    kind="select",
                    options=["uribe_xr_squared_rg"],
                    visibility="EXPERT",
                    description="Interprets the first Uribe table column as x_r=sqrt(r/r_g), so r_rg=x_r^2.",
                ),
                field(
                    "photon_escape_classifier",
                    "uribe_radial_interpolation_mode",
                    "Uribe radial interpolation",
                    "linear",
                    kind="select",
                    options=["linear", "nearest"],
                    visibility="EXPERT",
                    description="Interpolation mode for radial Uribe scalar fields.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    "fail",
                    kind="select",
                    options=["fail", "vacuum", "nearest"],
                    visibility="EXPERT",
                    description="Out-of-bounds policy for radial Uribe scalar lookup. fail is the conservative default.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    "fail",
                    kind="select",
                    options=["fail", "drop_bad_first_point"],
                    visibility="EXPERT",
                    description="Policy for the known first-coordinate anomaly in disk-electron-fraction.dat.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    options=["fail", "zamo"],
                    visibility="EXPERT",
                    description="Uribe radial scalar has no u_fluid. fail is physical default; zamo is only for plumbing tests and marks physics risk.",
                ),
                field(
                    "photon_escape_classifier",
                ...
                field(
                    ...
                    "Enable photon observer spectra",
                    False,
                    kind="checkbox",
                    visibility="EXPERT",
                    description="Builds ideal photon observer spectra after validated_zamo redshift and a passing photon validation gate. No detector response, aperture acceptance, or instrument response is applied.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    "inside_fov_only",
                    kind="select",
                    options=["inside_fov_only", "all_reached_observer_sphere"],
                    visibility="EXPERT",
                    description="Controls whether spectra use only camera inside-FOV photons or all validated photons that reached the observer sphere.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    options=["log", "linear"],
                    visibility="EXPERT",
                    description="Energy binning mode for photon observer spectra.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_spectrum_n_bins",
                    "Photon spectrum bins",
                    32,
                    kind="number",
                    visibility="EXPERT",
                    description="Number of bins for photon observer spectra.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_spectrum_energy_min_gev",
                    "Photon spectrum min energy (GeV)",
                    "auto",
                    kind="text",
                    visibility="EXPERT",
                    description="Minimum spectrum energy in GeV, or auto to infer it from selected photons.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_spectrum_energy_max_gev",
                    "Photon spectrum max energy (GeV)",
                    "auto",
                    kind="text",
                    visibility="EXPERT",
                    description="Maximum spectrum energy in GeV, or auto to infer it from selected photons.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_spectrum_generate_plots",
                    "Generate photon spectrum plots",
                    True,
                    kind="checkbox",
                    visibility="EXPERT",
                    description="Writes lightweight diagnostic spectrum plots. These are not paper-ready and are not detector-folded.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_spectrum_include_frequency",
                    "Include photon frequency spectrum",
                    True,
                    kind="checkbox",
                    visibility="EXPERT",
                    description="Also writes a frequency-domain spectrum using nu = E_obs / h.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_spectrum_require_validation",
                    "Require validation for photon spectra",
                    True,
                    kind="checkbox",
                    visibility="EXPERT",
                    description="Requires photon validation physics_status=PASS before writing spectra. Keep enabled for scientific runs.",
                ),
                field(
                    "photon_escape_classifier",
                    "enable_photon_opacity",
                    "Enable photon opacity",
                    False,
                    kind="checkbox",
                    visibility="EXPERT",
                    description="Runs optional Phase 6 photon propagation-opacity infrastructure after validation. constant_alpha_path is a synthetic on-the-fly accumulator test, not a medium opacity model.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_opacity_mode",
                    ...
                    "disabled",
                    kind="select",
                    options=["disabled", "vacuum", "constant_alpha_path", "density_gray_toy", "gamma_gamma_local_blackbody"],
                    visibility="EXPERT",
                    description="disabled keeps ideal products. vacuum writes tau=0. constant_alpha_path uses path length. density_gray_toy uses medium-compressed complete paths. gamma_gamma_local_blackbody is diagnostic Breit-Wheeler opacity with an alpha table.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    kind="number",
                    visibility="EXPERT",
                    description="Synthetic constant opacity coefficient for constant_alpha_path. Must be non-negative. This is a contract/integration test, not physical opacity.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_density_gray_kappa_per_rg_per_gcm3",
                    "Photon density gray kappa",
                    0.0,
                    kind="number",
                    visibility="EXPERT",
                    description="Toy density-gray opacity coefficient for density_gray_toy: alpha = kappa*rho*(E/E_ref)^q. Must be non-negative.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    kind="number",
                    visibility="EXPERT",
                    description="Toy density-gray energy exponent q. q=0 ignores E_gamma_fluid.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    kind="number",
                    visibility="EXPERT",
                    description="Positive reference energy for density_gray_toy.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_gamma_gamma_target_field_model",
                    "Gamma-gamma target field model",
                    "local_blackbody_isotropic",
                    kind="select",
                    options=["local_blackbody_isotropic"],
                    visibility="EXPERT",
                    description="Diagnostic gamma-gamma opacity target field. First implementation only supports local isotropic blackbody.",
                ),
                field("photon_escape_classifier", "photon_gamma_gamma_dilution_factor", "Gamma-gamma dilution factor", 1.0, kind="number", visibility="EXPERT", description="Multiplicative dilution for the local blackbody target photon density. Must be >= 0."),
                field("photon_escape_classifier", "photon_gamma_gamma_energy_grid_min_gev", "Gamma-gamma min energy (GeV)", 1.0e-6, kind="number", visibility="EXPERT", description="Minimum UHE photon energy for the precomputed Breit-Wheeler alpha table."),
                field("photon_escape_classifier", "photon_gamma_gamma_energy_grid_max_gev", "Gamma-gamma max energy (GeV)", 1.0e6, kind="number", visibility="EXPERT", description="Maximum UHE photon energy for the precomputed Breit-Wheeler alpha table."),
                field("photon_escape_classifier", "photon_gamma_gamma_temperature_grid_min_mev", "Gamma-gamma min temperature (MeV)", 1.0e-3, kind="number", visibility="EXPERT", description="Minimum local blackbody temperature for the alpha table."),
                field("photon_escape_classifier", "photon_gamma_gamma_temperature_grid_max_mev", "Gamma-gamma max temperature (MeV)", 10.0, kind="number", visibility="EXPERT", description="Maximum local blackbody temperature for the alpha table."),
                field("photon_escape_classifier", "photon_gamma_gamma_n_energy_bins", "Gamma-gamma energy bins", 64, kind="number", visibility="EXPERT", description="Number of log-spaced energy bins in the alpha table."),
                field("photon_escape_classifier", "photon_gamma_gamma_n_temperature_bins", "Gamma-gamma temperature bins", 64, kind="number", visibility="EXPERT", description="Number of log-spaced temperature bins in the alpha table."),
                field("photon_escape_classifier", "photon_gamma_gamma_n_epsilon_quad", "Gamma-gamma epsilon quadrature", 64, kind="number", visibility="EXPERT", description="Target photon energy quadrature points used during alpha-table precomputation."),
                field("photon_escape_classifier", "photon_gamma_gamma_n_mu_quad", "Gamma-gamma angular quadrature", 32, kind="number", visibility="EXPERT", description="Angular quadrature points used during alpha-table precomputation."),
                field("photon_escape_classifier", "photon_gamma_gamma_max_table_cells", "Gamma-gamma max table cells", 4096, kind="number", visibility="EXPERT", description="Safety guard: n_energy_bins*n_temperature_bins must not exceed this value."),
                field("photon_escape_classifier", "photon_gamma_gamma_max_steps_per_photon", "Gamma-gamma max steps per photon", 200000, kind="number", visibility="EXPERT", description="Safety guard for diagnostic gamma-gamma accumulation."),
                field("photon_escape_classifier", "photon_gamma_gamma_step_stride", "Gamma-gamma step stride", 1, kind="number", visibility="EXPERT", description="Accumulate gamma-gamma opacity every N geodesic steps. Must be >= 1."),
                field("photon_escape_classifier", "photon_gamma_gamma_alpha_floor_cm_inv", "Gamma-gamma alpha floor (cm^-1)", 1.0e-300, kind="number", visibility="EXPERT", description="Positive floor used only for log-alpha interpolation of the precomputed table."),
                field("photon_escape_classifier", "photon_gamma_gamma_table_direct_integral_tolerance", "Gamma-gamma table direct tolerance", 0.2, kind="number", visibility="EXPERT", description="Relative tolerance target for table-vs-direct-integral validation tests."),
                field("photon_escape_classifier", "photon_gamma_gamma_fail_on_invalid", "Fail on invalid gamma-gamma", True, kind="checkbox", visibility="EXPERT", description="Fail if diagnostic gamma-gamma accumulation hits invalid values or configured limits."),
                field("photon_escape_classifier", "photon_gamma_gamma_requires_medium", "Gamma-gamma requires medium", True, kind="checkbox", visibility="EXPERT", description="Requires the configured analytic_torus medium contract for local blackbody temperature."),
                field(
                    "photon_escape_classifier",
                    ...
                    options=["fail", "exclude", "diagnostic_only"],
                    visibility="EXPERT",
                    description="Policy for truncated paths in path-integrated toy/physical opacity. fail is the conservative default.",
                ),
                field(
                    "photon_escape_classifier",
                    "photon_opacity_fail_on_invalid",
                    "Fail on invalid photon opacity",
                    True,
                    kind="checkbox",
                    visibility="EXPERT",
                    description="If enabled, Phase 6 fails when any row cannot produce valid opacity fields.",
                ),
                field(
                    "photon_escape_classifier",
                    ...
                    "separate_file",
                    kind="select",
                    options=["separate_file"],
                    visibility="EXPERT",
                    description="Writes photon_observer_camera_attenuated.csv separately and never overwrites the ideal redshift camera file.",
                ),
                field(
                    "photon_escape_classifier",
...
def final_pipeline_config(values: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "enable_photon_path_sampling": photon_escape["enable_photon_path_sampling"],
        "photon_path_sample_stride": photon_escape["photon_path_sample_stride"],
        "photon_path_sample_max_rows_per_photon": photon_escape["photon_path_sample_max_rows_per_photon"],
        "photon_path_sampling_output_format": photon_escape["photon_path_sampling_output_format"],
        "photon_path_sampling_require_validation": photon_escape["photon_path_sampling_require_validation"],
        "enable_photon_path_compression": photon_escape["enable_photon_path_compression"],
        "photon_path_compression_mode": photon_escape["photon_path_compression_mode"],
        "photon_path_compression_stride": photon_escape["photon_path_compression_stride"],
        "photon_path_compression_require_complete_paths": photon_escape["photon_path_compression_require_complete_paths"],
        "photon_path_compression_output_format": photon_escape["photon_path_compression_output_format"],
        "photon_medium_model": photon_escape["photon_medium_model"],
        "photon_medium_input_path_mode": photon_escape["photon_medium_input_path_mode"],
        "photon_medium_truncated_path_policy": photon_escape["photon_medium_truncated_path_policy"],
        "photon_medium_torus_rho0_g_cm3": photon_escape["photon_medium_torus_rho0_g_cm3"],
        "photon_medium_torus_r0_rg": photon_escape["photon_medium_torus_r0_rg"],
        "photon_medium_torus_sigma_r_rg": photon_escape["photon_medium_torus_sigma_r_rg"],
        "photon_medium_torus_H_over_r": photon_escape["photon_medium_torus_H_over_r"],
        "photon_medium_torus_temperature_mev": photon_escape["photon_medium_torus_temperature_mev"],
        "photon_medium_torus_Ye": photon_escape["photon_medium_torus_Ye"],
        "photon_medium_torus_fluid_frame": photon_escape["photon_medium_torus_fluid_frame"],
        ...
        "enable_photon_observer_spectra": photon_escape["enable_photon_observer_spectra"],
        "photon_spectrum_selection": photon_escape["photon_spectrum_selection"],
        "photon_spectrum_binning": photon_escape["photon_spectrum_binning"],
        "photon_spectrum_n_bins": photon_escape["photon_spectrum_n_bins"],
        "photon_spectrum_energy_min_gev": photon_escape["photon_spectrum_energy_min_gev"],
        "photon_spectrum_energy_max_gev": photon_escape["photon_spectrum_energy_max_gev"],
        "photon_spectrum_generate_plots": photon_escape["photon_spectrum_generate_plots"],
        "photon_spectrum_include_frequency": photon_escape["photon_spectrum_include_frequency"],
        "photon_spectrum_require_validation": photon_escape["photon_spectrum_require_validation"],
        "enable_photon_opacity": photon_escape["enable_photon_opacity"],
        "photon_opacity_mode": photon_escape["photon_opacity_mode"],
        "photon_constant_alpha_per_rg": photon_escape["photon_constant_alpha_per_rg"],
        "photon_density_gray_kappa_per_rg_per_gcm3": photon_escape["photon_density_gray_kappa_per_rg_per_gcm3"],
        "photon_density_gray_energy_exponent": photon_escape["photon_density_gray_energy_exponent"],
        "photon_density_gray_reference_energy_gev": photon_escape["photon_density_gray_reference_energy_gev"],
        "photon_gamma_gamma_target_field_model": photon_escape["photon_gamma_gamma_target_field_model"],
        "photon_gamma_gamma_dilution_factor": photon_escape["photon_gamma_gamma_dilution_factor"],
        "photon_gamma_gamma_energy_grid_min_gev": photon_escape["photon_gamma_gamma_energy_grid_min_gev"],
        "photon_gamma_gamma_energy_grid_max_gev": photon_escape["photon_gamma_gamma_energy_grid_max_gev"],
        "photon_gamma_gamma_temperature_grid_min_mev": photon_escape["photon_gamma_gamma_temperature_grid_min_mev"],
        "photon_gamma_gamma_temperature_grid_max_mev": photon_escape["photon_gamma_gamma_temperature_grid_max_mev"],
        "photon_gamma_gamma_n_energy_bins": photon_escape["photon_gamma_gamma_n_energy_bins"],
        "photon_gamma_gamma_n_temperature_bins": photon_escape["photon_gamma_gamma_n_temperature_bins"],
        "photon_gamma_gamma_n_epsilon_quad": photon_escape["photon_gamma_gamma_n_epsilon_quad"],
        "photon_gamma_gamma_n_mu_quad": photon_escape["photon_gamma_gamma_n_mu_quad"],
        "photon_gamma_gamma_max_table_cells": photon_escape["photon_gamma_gamma_max_table_cells"],
        "photon_gamma_gamma_max_steps_per_photon": photon_escape["photon_gamma_gamma_max_steps_per_photon"],
        "photon_gamma_gamma_step_stride": photon_escape["photon_gamma_gamma_step_stride"],
        "photon_gamma_gamma_alpha_floor_cm_inv": photon_escape["photon_gamma_gamma_alpha_floor_cm_inv"],
        "photon_gamma_gamma_table_direct_integral_tolerance": photon_escape["photon_gamma_gamma_table_direct_integral_tolerance"],
        "photon_gamma_gamma_fail_on_invalid": photon_escape["photon_gamma_gamma_fail_on_invalid"],
        "photon_gamma_gamma_requires_medium": photon_escape["photon_gamma_gamma_requires_medium"],
        "photon_opacity_truncated_path_policy": photon_escape["photon_opacity_truncated_path_policy"],
        "photon_opacity_fail_on_invalid": photon_escape["photon_opacity_fail_on_invalid"],
        "photon_opacity_output_mode": photon_escape["photon_opacity_output_mode"],
